  ...
  const columns = [
    {
      ...
      renderContent: (value) => (
        <div className="flex items-center">
          <div className="w-10 h-10 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-lg flex items-center justify-center mr-3 shadow-sm">
            <svg
    ...
    },
    {
      ...
      key: "category",
      renderContent: (value) => (
        <span className="px-3 py-1.5 bg-gradient-to-r from-indigo-50 to-indigo-100 text-indigo-700 rounded-lg text-sm font-medium border border-indigo-200">
          {value || "-"}
        </span>
      ),
    },
    {
      ...
      renderContent: (value) => (
        <span
          ...
          <span
            className={`w-2 h-2 rounded-full mr-2 ${value ? "bg-green-500 animate-pulse" : "bg-gray-500"}`}
          />
  ...
  if (loading) {
    return (
      <div className="w-full">
        <TableSkeletonLoader tableHeaderCount={4} tableValueCount={13} />
      </div>
    );
  }
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              View and manage all equipment • {equipment.length} Total Entries
            </p>
          </div>
